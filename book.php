			...
			<div class="container">
				<div class="booking-form-w3layouts">
					...
					<div class="block-9 mt-5 mb-4">
						<div class="">
							<h2 class="h4 mb-4" style="color: grey;">Informasi Reservasi</h2>
							<div class="d-flex ftco-animate">
								<div class="col-md-12 flex-column">
									<div class="row d-block flex-row">
										<div class="col mb-2 d-flex py-4 border" style="background: white;">
											<div class="align-self-center">
												<p class="mb-0"><span class="color-span-title"><i class="fas fa-user-tag fa-lg fa-fw mr-4" aria-hidden="true"></i> Nama Depan :</span> <span class="color-span"><?php echo $reservation_name; ?></span></p>
											</div>
										</div>
										<div class="col mb-2 d-flex py-4 border" style="background: white;">
											<div class="align-self-center">
												<p class="mb-0"><span class="color-span-title"><i class="fas fa-user fa-lg fa-fw mr-4" aria-hidden="true"></i> Nama Belakang : </span> <span class="color-span"><?php echo $reservation_firstname; ?></span></p>
											</div>
										</div>
										<div class="col mb-2 d-flex py-4 border" style="background: white;">
											<div class="align-self-center">
					...
					<form action="manage-insert.php" method="POST">
						<div class="col-lg-12" style="text-align: center;">
							...
							<input type="submit" value="Pesan" name="book" class="btn btn-warning">
						</div>
					</form>
				</div>
			</div>
