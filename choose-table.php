    ...
    <section class="ftco-section" style="margin-top: 10em;">
      <div class="container">
        <div class="booking-form-w3layouts">
          ...
          <form action="book.php" method="POST">
            <div class="row">
              ...
              <div class="col-md-12 dish-menu">
                <?php
                echo "<br>";
                echo "Tanggal: " . date("d/m/Y", strtotime($reservation_date));
                echo "<br>";
                echo " Jam : " . $reservation_time;
                ?>
                    ...
                    <div class="row">
                      ...
                      ?>
                        <div class="col-lg-3" style="min-height: 190px">
                          <p class="text-center" style="font-weight: bold; color: grey;">Meja Untuk <?php echo @$i += 1 ?> Orang</p>
                          <nav class="menu2">
                            <ul style="list-style-type: none;">
                              ...
                              foreach ($result2 as $r2) {
                                ...
                                if ($cbbookresult->num_rows > 0) {
                                  ...
                                  <label for="disabled" class="border-input disabled-input">Tidak Tersedia</label>';
                                }
                                if ($booked == true) {
                              ?>
                                  <li class="menu-item2">
          ...
          <small class="text-center" style="color: grey;">**Jika Anda membutuhkan meja untuk rombongan lebih dari 8 orang, silakan menghubungi pihak kedai secara langsung.</small>
        </div>
      </div>
    </section>
