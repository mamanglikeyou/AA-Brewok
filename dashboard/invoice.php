						...
						<div class="invoice">
							<header class="clearfix">
								<div class="row">
									<div class="col-sm-4 mt-md">
										<h2 class="h2 mt-none mb-sm text-dark text-bold">Reservasi</h2>
							...
							<div class="bill-info">
								<div class="row">
									<div class="col-md-6">
										<div class="bill-to">
											<p class="h4 mb-xs text-dark text-semibold">Informasi Pelanggan :</p>
											<address>
												<?php echo "Nama Lengkap : " . $booking_name; ?>
												<?php echo $booking_first_name; ?>
												<br />
												<!-- French number phone -->
												Phone : +62 8<?php echo $booking_phone; ?>
											</address>
										</div>
									</div>
									<div class="col-md-6">
										<div class="bill-data text-right">
											<p class="h4 mb-xs text-dark text-semibold">Informasi Reservasi :</p>
											<p class="mb-none">
												<span class="text-dark">Tanggal Reservasi :</span>
												<span class="value"><?php echo date("d/m/Y", strtotime($booking_date)); ?></span>
											</p>
											<p class="mb-none">
												<span class="text-dark">Waktu Reservasi :</span>
							...
							<div class="bill-info">
								<div class="row">
									<div class="col-md-6">
										<div class="bill-to">
											<p class="h4 mb-xs text-dark text-semibold">Jumlah Orang dan Nomor Meja:</p>
											<address id="table">
												<?php
												$booking_number = $_GET['booking-number'];
