				...
				<section class="panel">
					<header class="panel-heading">
						...
						<p class="panel-subtitle">
							Di sini akses ke <code>daftar menu</code> Anda, jika Anda ingin menghapus produk dari menu Anda, silakan gunakan tombol <code>"Hapus"</code>.
						</p>
					</header>
							...
							<tbody>
								...
								?>
									<tr class="gradeX">
										...
										<td class="center hidden-phone">
											<a href="menu-manage.php?menu_id=<?php echo $r['id']; ?>" class="btn btn-danger btn-block btn-sm" onclick="if (!Done()) return false; ">Hapus</a>
										</td>
									</tr>
								<?php $count++;
								} ?>
