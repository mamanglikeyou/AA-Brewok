						...
						<form action="manage-insert.php" method="POST" enctype="multipart/form-data">
							<section class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Tambahkan Meja Baru</h2>
									<p class="panel-subtitle">
										Untuk menambahkan <code>tipe Meja</code>, silakan pilih dari menu drop down.
										<br><br>
										Lalu masuk ke menu nav-bar kiri : <code>"Kelola Meja"</code> dan <code>"Daftar Meja yang Tersedia"</code>, untuk menambahkan berapa banyak setiap meja yang Anda miliki.										
									</p>
								</header>
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label class="control-label">Tipe meja yang Anda miliki di restoran Anda</label>
												<div class="form-group">
								...
								<footer class="panel-footer">
									<input type="submit" name="addtable" class="btn btn-warning btn-sm" value="Tambahkan">
								</footer>
							</section>
						</form>
					</div>
