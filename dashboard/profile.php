          ...
          <div class="row">
            <div class="col-lg-3">
              ...
              <div class="panel panel-default">
                ...
                <ul class="list-group">
                  <li class="list-group-item text-muted" style="text-align: center;">Profil Kedai</li>
                  <li class="list-group-item text-right"><span class="pull-left"><strong>Kedai</strong></span>
                    <?php echo '<div style="text-transform: capitalize;">' . $row['rc_name'] . '</div>'; ?>
                  </li>
                  <li class="list-group-item text-right"><span class="pull-left"><strong>Buka / Tutup </strong></span><br>
                    <?php
                    $id = $_SESSION['id'];
                    $con = connect();
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div class="text-left" style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Buka :<?php echo date('H:i', strtotime($r['opening_res'])); ?> WIB</div>
                    <?php
                    }
                    ?>
                    <?php
                    ...
                    foreach ($result as $r) {
                    ?>
                      <div class="text-left" style="color: rgb(63, 153, 63); font-weight: 600;" class="opening">Tutup : <?php echo date('H:i', strtotime($r['closing_res'])); ?> WIB</div>
                    <?php
                    }
                    ?>
                  </li>
              ...
              <form class="form-horizontal" method="POST" action="profile.php">
                <div class="row">
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Fname">Nama Kedai :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Lname">Web Site :</label>
                      <div class="col-md-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      ...
                      <div class="col-md-8">
                        <input type="text" name="phone" class="form-control" required="" minlength="10" maxlength="10" placeholder="10 digit no.belakang" value="<?php echo '0' . $row['phone']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <div class="col-md-7">
                      <label class="col-md-4 control-label" for="Gender">Alamat :</label>
                      <div class="col-md-8">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Gambar/Logo.</h4>
      </div>
