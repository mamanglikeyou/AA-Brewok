				...
				<section class="panel">
					...
					<header class="panel-heading">
						...
						<p class="panel-subtitle">
							Untuk menambahkan <code>meja baru</code>, silakan pilih tombol <code>"Tambah"</code>. <br><br>
								...
								?>
									<tr class="gradeX">
										...
										<td class="center hidden-phone">
											<a href="delete-table-num.php?table_id=<?php echo $r['id']; ?>&tbl_id=<?php echo $tbl_id; ?>" class="btn btn-danger btn-sm" onclick="if (!Done()) return false; ">Hapus</a>
										</td>
									</tr>
								<?php $count++;
								} ?>
				...
				<form action="" method="POST">
					<div class="modal-body">
						<div class="form-group">
							<label>Nomor dari Meja yang tersedia</label>
							<input type="number" name="num_of_chair" required="" class="form-control" min="1" max="15" placeholder="min 1 - max 15">
						</div>
					</div>
					<div class="modal-footer">
						<input type="submit" name="addchair" class="btn btn-warning btn-sm" value="Tambah">
...
if (isset($_POST['addchair'])) {
	...
	if ($insert == true) {
		echo '<script>
                    swal({
						title: "Sukses!",
						text: " Meja Berhasil Ditambahkan Berhasil!",
						icon: "success",
						button: "ok",
                    }).then(function() {
