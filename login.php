    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-5">
        <div class="col-md-7 text-center heading-section ftco-animate">
          ...
          <h4>Masuk ke website untuk memesan meja di kedai favorit Anda.</h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 dish-menu">
          <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link py-3 px-4 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span class="flaticon-meat"></span> Log in Akun</a>
          </div>
                  ...
                  <div class="d-flex ftco-animate form-border" style="background: white;">
                    <div class="row" style="width: 100%">
                      <div class="col-md-12">
                        ...
                        <p class="text-center">Untuk Registrasi <a href="register.php">Klik Disini</a> </p>
                      </div>
                    </div>
                  </div>
                </div>
