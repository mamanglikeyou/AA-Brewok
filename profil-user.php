    ...
    <section role="main" class="content-body">
      <div class="booking-form-w3layouts" style="width: 45%;">
        <header class="page-header">
          <h3 class="sub-heading-agileits">Profil Saya</h3>
        </header>
                  ...
                  <div class="form-inline">
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user-tag fa-lg fa-fw mr-1" aria-hidden="true"></i> First Name :</span> <input style="text-transform: capitalize;" type="text" name="fullname" class="form-control" required="" placeholder="Nom" value="<?php echo $row['rc_name']; ?>"> </p>
                      </div>
                    </div>
                    <div class="col mb-2 d-flex py-4" style="background: white;">
                      <div class="align-self-center">
                        <p class="mb-0"><span class="color-span-title"><i class="fas fa-user fa-lg fa-fw mr-1" aria-hidden="true"></i> Last Name : </span> <input style="text-transform: capitalize;" type="text" name="first_name" class="form-control no-outline" required="" placeholder="Prénom" value="<?php echo $row['first_name']; ?>"></p>
                      </div>
                    </div>
                  </div>
                  <div class="form-inline">
                    ...
                    <div class="col mb-2 d-flex py-4 ">
                      <div class="align-self-center">
                        <div class="col-md-7">
                          ...
                          <div class="col-md-8">
                            <input id="btn-loader" type="submit" value="Save" name="save" class="btn btn-warning">
                          </div>
                        </div>
                      </div>
                    </div>
