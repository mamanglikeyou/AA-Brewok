      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">Membuat Akun Baru</span>
            <h4>Registrasi untuk reservasi kedai favorit kamu.</h4>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 dish-menu">
            <div class="nav nav-pills justify-content-center ftco-animate" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link py-3 px-4 active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span class="flaticon-meat"></span>Akun Pelanggan </a>
                        ...
                        <div class="col-md-12">
                          <form class="form-register" action="manage-insert.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group input-with-icon">
                              <input type="text" name="rc_name" class="form-control" required="" placeholder="Nama Depan" style="text-transform: capitalize;">
                              <i class="fas fa-user-tag fa-lg fa-fw" aria-hidden="true"></i>
                            </div>
                            <div class="form-group input-with-icon">
                              <input type="text" name="first_name" class="form-control" required="" placeholder="Nama Belakang" style="text-transform: capitalize;">
                            ...
                            <div class="form-group  text-center">
                              <input type="submit" value="Registrasi" name="submit" class="btn btn-warning">
                            </div>
                          </form>
                          <p class="text-center">Untuk Login <a href="login.php">Klik Disini</a> </p>
                        </div>
                      </div>
                    </div>
                  </div>
