        ...
        <div class="row justify-content-md-center">
          <form action="book.php" method="POST">
            <div class="col-md-12 text-center marb-35">
              <div class="header-h">Temukan Kedai Ekslusif Kami</div>
              <p class="header-p">Di sini Anda akan menemukan daftar semua cabang kedai kami.
              </p>
            </div>
            <div class="col-md-12 text-center" id="menu-filters">
              <ul class="ul-menus">
                <li><a class="filter active" data-filter=".menu-restaurant">Semua</a></li>
              </ul>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <?php
                $con = connect();
                $sql = "SELECT * FROM `rc_info` WHERE location = '$area_id' AND `category` = 11;";
                $result = $con->query($sql);
                foreach ($result as $r) {
                ?>
                  <div class="Coffee menu-restaurant">
                    <div class="menus">
                      <div class="menu-img">
                        <img class="rounded-circle" src="dashboard/user-image/<?php echo $r['logo']; ?>" alt="image" width="100" height="100" style="margin-right: 2em ;">
                      </div>
