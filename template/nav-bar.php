	...
	<div class="collapse navbar-collapse" id="ftco-nav">
		...
		<ul class="ul">
			<li class="ul">
				<div class="logo-holder logo-5">
						<h3>Aa`Brewok</h3>
						<p class="p" style="font-style: normal; font-weight: 100; font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif">Website Reservasi</p>
					</a>
				</div>
			</li>
		</ul>
		...
		<ul class="navbar-nav ml-auto">
			...
			<?php if (!isset($_SESSION['isLoggedIn'])) { ?>
				<li class="nav-item"><a href="register.php" class="nav-link">Registrasi</a></li>
			...
			<?php } elseif (isset($_SESSION['isLoggedIn'])) { ?>
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="profil-user.php" class="nav-link"><i class="far fa-user-circle"></i> Profil Saya</a>
